					...
					<ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
							...
							<ul class="dropdown-menu">
								...
								<li><a href="../../scripts/php/users/logout.php"><i class="lnr lnr-exit"></i> <span>Logout</span></a></li>
							</ul>
						</li>
					...
					<ul class="nav">						
                        <li>
							...
							<div id="subPages" class="collapse ">
								<ul class="nav">
									<li><a href="../clientes/clientes.php" class="">Clientes</a></li>
									<li><a href="../produtos/produtos.php" class="">Produtos</a></li>
